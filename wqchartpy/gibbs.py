...
def plot_Gibbs(df, 
    ...
    # Creat the legend
    ax1.legend(loc='upper left', markerscale=1, frameon=False, 
...
plot_Gibbs(df, unit='mg/L', figname='Gibbs diagram', figformat='pdf')
